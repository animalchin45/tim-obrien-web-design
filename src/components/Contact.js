        ...
        <section id="contact" className="portfolio__section portfolio__section--contact">
            ...
            <div className="contact">
                <div className="contact__header">
                    <p className="u-margin-bottom">Ready to create or upgrade your presence on the web? If you want to learn more about how I can help bring your business to the next level contact me today.</p>
