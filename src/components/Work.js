  ...
  <>
    ...
    >
      ...
      <div className='work__job'>
        ...
        <p className='work__text'>
          MERN stack project that is expanding my knowledge of Node.js and Redux
          while also showcasing my growing skillset. Users can search movie and
          tv titles that they can save and rate.
        </p>
    ...
    <section id='work' className='portfolio__section portfolio__section--work'>
      ...
      <div className='work__job'>
        ...
        <p className='work__text'>
          A single page project that takes you on an informative journey through
          the solar system. Users can explore topics about each planet in
          detail.
        </p>
    ...
    <section id='work' className='portfolio__section portfolio__section--work'>
      <div className='work__job'>
        ...
        <p className='work__text'>
          ...
          project. Users are able to search for words, hear pronunciations, and
          learn different meanings.
        </p>
